...
- **Level 3 (Standardise):** A single template, in-repo storage, and a defined lifecycle and governance (raise/skip criteria, roles, review cadence) are documented and applied consistently org-wide; records are reviewed and superseded rather than silently edited.
...
- Keep records **specific, timestamped, and lightweight**; standardise on one template (Nygard, MADR, or similar).
...
- The ROI is avoided rediscovery and wrong-reversal cost; the TCO case is strongest where turnover, modernisation, and audit matter most. See chapter 1.5 (decision-making and governance) and chapter 3.1 (architecture fundamentals).
