...
- [ ] Security-sensitive input is validated, encoded, or parameterised appropriately.
...
- [ ] Authorisation checks enforce least privilege for every action and resource.
...
- [ ] Injection, deserialisation, and SSRF risks are mitigated for untrusted input.
...
- [ ] The personal data collected is inventoried, classified, and minimised to what is needed.
...
- [ ] Retention periods are defined and deletion or anonymisation is automated.
...
- [ ] Authentication and authorisation are specified for every operation.
...
- [ ] Sensitive data exposure in responses is minimised and justified.
...
- [ ] Prioritise mitigation and restoring service over root-cause analysis.
...
- [ ] Alert thresholds are tuned to minimise noise and false pages.
...
- [ ] Network exposure is minimised; no unintended public access.
...
## Open source intake and licence review checklist

Before adopting an open source component.

- [ ] The component's licence is identified and is on the approved list.
- [ ] Licence obligations (attribution, copyleft, notices) are understood and met.
- [ ] Licence compatibility with your distribution model is confirmed.
...
For systems requiring formal authorisation to operate.

- [ ] The system boundary and data flows are defined and diagrammed.
- [ ] Data is categorised by impact level and sensitivity.
...
- [ ] The authorising official has the risk assessment needed to grant authorisation.
- [ ] Reauthorisation triggers and the ongoing authorisation cadence are defined.
