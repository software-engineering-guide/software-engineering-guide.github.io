...
**Level 3 (Standardise).** The organisation adopts a shared quality model (such as ISO/IEC 25010), separates QA from QC, and runs quality management processes with quality plans and acceptance criteria, documented and applied consistently across teams. Verification and validation are distinct and deliberate, and defects are classified and root-caused to an agreed scheme.
...
**Level 5 (Orchestrate).** Quality is a continuously improved, culturally owned discipline integrated with business and risk planning. Prevention is the emphasis, cost-of-quality data guides where investment goes, and root-cause findings systematically prevent recurrence. Teams own quality end to end, metrics feed continuous improvement, and the organisation adapts its quality practice as products, risks, and regulation shift. This aligns with the higher levels of the maturity models in chapter 10.8.

## Ideas for discussion

- Which ISO/IEC 25010 quality characteristics matter most for your systems, and what is "good enough" for each?
- Where does your organisation sit on the prevention-appraisal-failure spending mix, and should it shift?
...
- Measure quality with a few meaningful metrics, and characterise defects by severity and root cause to prevent recurrence.
