...
**Government.** Transparency, procurement rules, and accountability shape every choice. Favor systems that cite official sources rather than generate policy, keep a human accountable for consequential decisions, and demand data portability and disclosure of model limitations in contracts. Publish a plain-language description and an appeals route, honor any multi-year exit obligations you sign, and keep AI out of final assessment decisions that must rest with an accountable officer.
