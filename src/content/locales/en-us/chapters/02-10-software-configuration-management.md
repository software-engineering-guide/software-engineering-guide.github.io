...
- **Level 2 (Develop):** Basic practices exist but vary from team to team. Some systems define configuration items and a change process and version their releases, baselines exist here and there, but records are partly manual and the rigor of control is inconsistent across the organization.
