...
- **Level 1, Initiate:** Modeling is implicit and reactive. Tables are designed physical-first by whoever needs them. Metrics are redefined in every report, and numbers routinely conflict. Grain is undocumented, and nobody owns the definitions.
