...
- **Output theater.** Counting artefacts produced (documents, tickets, features shipped) while real outcomes go unmeasured, common where there is no market price.
