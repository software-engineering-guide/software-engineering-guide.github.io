...
**[Prompt injection](https://en.wikipedia.org/wiki/Prompt_injection)**: An attack in which crafted input causes a language model to ignore its intended instructions and follow the attacker's instead, the AI-era analog of injection flaws. It is a central security risk of LLM applications.
