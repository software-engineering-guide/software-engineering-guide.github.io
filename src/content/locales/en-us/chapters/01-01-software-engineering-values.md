...
- Level 3, Standardize: Blameless learning, clear non-overlapping ownership, and a writing culture are documented org-wide norms with templates, a service catalog, and defined on-call expectations. Leaders model the values and the same behaviors are expected everywhere, not just where a good manager happens to sit.
