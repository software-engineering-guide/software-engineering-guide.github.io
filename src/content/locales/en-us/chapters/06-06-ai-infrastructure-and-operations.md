...
**Small business.** With no platform team, treat serving, retrieval, and observability as things you buy inside tools you already use, not systems you staff. Favor managed inference and managed vector search with transparent, predictable pricing, and set a hard spend cap and a billing alert from day one. Frame the decision as buy versus build honestly: operating GPUs or a vector index rarely pays off at your volume, and a small model behind a hosted API usually meets the need at a fraction of the effort.
