...
**Small business.** With no performance specialist and a tight budget, lean on the tools you already pay for: the profiler in your runtime, the latency percentiles in your hosting dashboard, and the built-in query analyzer in your database. Set one or two plain budgets tied to something customers feel, such as page-load or checkout time, and treat a breach as a signal to buy a faster tier or fix the worst query rather than launch a tuning project you cannot staff.
