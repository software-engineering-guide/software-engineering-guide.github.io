...
- **Level 3, Standardise:** A shared design vocabulary, a rule of three for extracting abstractions, coupling and cohesion analysis, and bounded contexts aligned to teams are documented and expected org-wide, applied consistently in design review rather than left to individual taste.
...
- When has DRY led your team to the wrong abstraction, and how did you recognise it?
