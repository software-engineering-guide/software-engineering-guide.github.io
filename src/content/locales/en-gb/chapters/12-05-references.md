...
This appendix is an organised index of the real standards, frameworks, and
...
- Applicability depends on jurisdiction, sector, data types, and contractual
  terms. Many organisations must satisfy several of these at once.
...
| NIST Cybersecurity Framework (CSF) | National Institute of Standards and Technology | Voluntary framework organised around Govern, Identify, Protect, Detect, Respond, Recover. | 4.1, 4.4 Security foundations and operations |
...
| FedRAMP | US General Services Administration / FedRAMP PMO | Standardised security authorisation for cloud services used by federal agencies. | 4.3, 4.6 Cloud security and compliance |
...
| CMMC | US Department of Defence | Certification of defence-contractor cybersecurity maturity. | 4.6 Compliance (defence) |
...
| C4 model | Community (Simon Brown) | Four-level approach to visualising software architecture. | 2.7, 3.1 Documentation and architecture |
...
| Standard / framework | Issuing body | Scope (one line) | Primary chapters / domains |
| --- | --- | --- | --- |
| CIS Benchmarks | Centre for Internet Security | Consensus-based secure-configuration baselines for systems and cloud. | 4.3, 8.2 Infrastructure security and IaC |
...
| Standard / framework | Issuing body | Scope (one line) | Primary chapters / domains |
| --- | --- | --- | --- |
| DAMA-DMBOK | DAMA International | Body of knowledge organising data-management disciplines. | 7.1 Data strategy and governance |
...
| Data mesh | Community (Zhamak Dehghani) | Decentralised, domain-oriented approach to data as a product. | 7.1, 7.2 Data strategy and engineering |
...
matters. The list is organised under the book's ten parts. Read selectively:
...
- **Team Topologies: Organising Business and Technology Teams for Fast Flow**. Matthew Skelton and Manuel Pais. A practical vocabulary (stream-aligned, platform, enabling, and complicated-subsystem teams) for designing organisations that produce good software.
...
- **The Fearless Organisation: Creating Psychological Safety in the Workplace**. Amy C. Edmondson. The research foundation for blameless culture and the safety that makes learning from failure possible.
...
- **Threat Modelling: Designing for Security**. Adam Shostack. The practical, comprehensive guide to STRIDE and structured threat modelling as a routine engineering practice.
...
- **NIST SP 800-53: Security and Privacy Controls for Information Systems and Organisations**. NIST. The control catalogue at the heart of U.S. federal security and the basis for FedRAMP and FISMA authorisation.
- **NIST Cybersecurity Framework (CSF)**. NIST. The widely adopted identify-protect-detect-respond-recover structure for organising a security programme.
...
- **Weapons of Maths Destruction**. Cathy O'Neil. A vivid case for algorithmic accountability and the real-world harms of unexamined models, essential for public-sector AI.
...
- **The Data Warehouse Toolkit: The Definitive Guide to Dimensional Modelling**. Ralph Kimball and Margy Ross. The canonical reference on star schemas and dimensional modelling for analytics.
...
- **Data Mesh: Delivering Data-Driven Value at Scale**. Zhamak Dehghani. The founding text of the domain-oriented, product-centric approach to organising data at scale.
- **Storytelling with Data**. Cole Nussbaumer Knaflic. A practical guide to honest, clear data visualisation and communicating insight to decision-makers.
...
- **Escaping the Build Trap**. Melissa Perri. How organisations mistake output for outcome, and how product management fixes it, with direct relevance to portfolio and programme governance.
...
- **NIST SP 800-37: Risk Management Framework**. NIST. The process framework behind authorisation to operate (ATO) and continuous monitoring in U.S. federal systems.
- **The FinOps Foundation Framework**. FinOps Foundation. The reference model for cloud cost visibility, optimisation, and accountability across finance and engineering.
