...
- Analysis paralysis: agonising over easily reversible two-way-door decisions.
...
- Level 3 (Standardise): ADRs, a paved road, reversibility-based delegation, and a debt inventory are documented and enforced org-wide, so the compliant choice is the easy default and reasoning is searchable.
