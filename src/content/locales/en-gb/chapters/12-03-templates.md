...
These templates are copy-paste-ready starting points. Lift any template into your wiki, repository, or ticketing system and fill in the bracketed placeholders. Italicised notes and inline comments explain what belongs in each section; delete them once the section is filled. Keep templates lightweight: a template that is faster to skip than to complete will not be used. Adapt headings and sections to your organisation, but preserve the intent of each part.
