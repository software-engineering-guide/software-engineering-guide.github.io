...
**Level 2: Develop.** Basic practices appear but vary by team. A privacy policy exists and basic consent is captured, with some awareness of retention. Rights requests are handled manually and slowly, data classification is informal, and one team may map its data while another collects freely. Nothing is enforced consistently across the organization.
